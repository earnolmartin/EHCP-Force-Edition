...
function ext_list_bookmarks( $dir ) {
	...
	// Not doing this in production mode... what a terrible idea!
	/*
	...
	*/
	$html = "<div style='float: right; margin-right: 1em; position: absolute; top:15px; right:0;'><a href='../'>&laquo; Back to EHCP Control Panel</a></div>";

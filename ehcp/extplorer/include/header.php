...
function show_header($dirlinks='') {
	...
	echo "<td width=\"25%\" style=\"padding-left: 15px; color:black; text-align: right; vertical-align: middle;\">" . 
	"<div style='display:inline-block; margin-right: 1em; position: absolute; top:15px; right:0;'><a href='../'>&laquo; Back to EHCP Control Panel</a></div>"
		. "
	</td>\n";

...
$GLOBALS['ext_conf']['authentication_methods_allowed'] = array('ehcp');
...
$GLOBALS['webdav_authentication_method'] = 'ehcp'; // use one of the  authentication methods in /include/authentication

...
$GLOBALS["error_msg"] = array(
	...
	// root
	"home"				=> "The home directory does NOT exist, check your settings.",
	...
	// exist
	"direxist"			=> "This directory does NOT exist.",
	//"filedoesexist"	=> "This file already exists.",
	"fileexist"			=> "This file does NOT exist.",
	"itemdoesexist"		=> "This item already exists.",
	"itemexist"			=> "This item does NOT exist.",
	"targetexist"		=> "The target directory does NOT exist.",

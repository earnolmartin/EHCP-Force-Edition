...
--
-- Host: localhost
-- Generation Time: Mar 09, 2015 at 10:56 PM
...
CREATE TABLE IF NOT EXISTS `jml_contentitem_tag_map` (
...
CREATE TABLE IF NOT EXISTS `jml_content_types` (
...
CREATE TABLE IF NOT EXISTS `jml_postinstall_messages` (
...
CREATE TABLE IF NOT EXISTS `jml_tags` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `jml_ucm_base` (
...
CREATE TABLE IF NOT EXISTS `jml_ucm_content` (
...
CREATE TABLE IF NOT EXISTS `jml_ucm_history` (
...
CREATE TABLE IF NOT EXISTS `jml_user_keys` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,

...
<?php	if ($net2ftp_settings["functionuse_swfupload"]      == "yes") { ?><option value="toggleElement('upload');document.forms['BrowseForm'].BrowseSelect.selectedIndex = 0;"  title="<?php echo __("Upload files using a Flash applet"); ?>">&nbsp;&nbsp;&nbsp;<?php echo __("Flash Upload"); ?></option><?php } // end if ?>
	...
	<tr>
		<td colspan="<?php echo $total_colspan; ?>">
			...
			<div id="upload_shown" style="display: none; margin-top: 20px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px; padding: 5px; border: 1px solid #003250; line-height: normal;">
				...
				<div class="header21"><?php echo __("Upload files"); ?></div>

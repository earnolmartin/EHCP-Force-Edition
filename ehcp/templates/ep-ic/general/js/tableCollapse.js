...
function initialStyleSheet(){
	...
	switch(colorLoad){
	case 'green':
		document.getElementById('logo').src = "templates/ep-ic/general/images/logo.png";
		document.getElementById('stylesheet').href = "templates/ep-ic/general/css/progreen.css";
	break;
	case 'blue':
		document.getElementById('logo').src = "templates/ep-ic/general/images/logo_blue.png";
		document.getElementById('stylesheet').href = "templates/ep-ic/general/css/problue.css";
	break;
	case 'red':
		document.getElementById('logo').src = "templates/ep-ic/general/images/logo_red.png";
		document.getElementById('stylesheet').href = "templates/ep-ic/general/css/prored.css";
	break;
	case 'yellow':
		//alert(document.getElementById('logo').src);
		document.getElementById('logo').src = "templates/ep-ic/general/images/logo_yellow.png";
		//alert(document.getElementById('logo').src);
		//alert(document.getElementById('stylesheet').href);
		document.getElementById('stylesheet').href = "templates/ep-ic/general/css/proyellow.css";
		//alert(document.getElementById('stylesheet').href);
	break;
	case 'purple':
		document.getElementById('logo').src = "templates/ep-ic/general/images/logo_purple.png";
		document.getElementById('stylesheet').href = "templates/ep-ic/general/css/propurple.css";
	break;
	}

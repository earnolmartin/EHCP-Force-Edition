...
function collapse(image, tbl){
	var tblRows = tbl.rows;
		...
		count++;
		if(count % 2 ==0){
			image.src="templates/ep-ic_v1/general/images/collapse.gif";
		}else{
			image.src="templates/ep-ic_v1/general/images/expand.gif";
		}
}
...
function initialStyleSheet(){
	...
	switch(colorLoad){
	case 'green':
		document.getElementById('logo').src = "templates/ep-ic_v1/general/images/logo.png";
		document.getElementById('stylesheet').href = "templates/ep-ic_v1/general/css/progreen.css";
	break;
	case 'blue':
		document.getElementById('logo').src = "templates/ep-ic_v1/general/images/logo_blue.png";
		document.getElementById('stylesheet').href = "templates/ep-ic_v1/general/css/problue.css";
	break;
	case 'red':
		document.getElementById('logo').src = "templates/ep-ic_v1/general/images/logo_red.png";
		document.getElementById('stylesheet').href = "templates/ep-ic_v1/general/css/prored.css";
	break;
	case 'yellow':
		//alert(document.getElementById('logo').src);
		document.getElementById('logo').src = "templates/ep-ic_v1/general/images/logo_yellow.png";
		//alert(document.getElementById('logo').src);
		//alert(document.getElementById('stylesheet').href);
		document.getElementById('stylesheet').href = "templates/ep-ic_v1/general/css/proyellow.css";
		//alert(document.getElementById('stylesheet').href);
	break;
	case 'purple':
		document.getElementById('logo').src = "templates/ep-ic_v1/general/images/logo_purple.png";
		document.getElementById('stylesheet').href = "templates/ep-ic_v1/general/css/propurple.css";
	break;
	}
